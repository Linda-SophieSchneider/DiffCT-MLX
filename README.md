...
> [!NOTE]
> **This is the `cuda` branch of [DiffCT-MLX](https://github.com/Linda-SophieSchneider/DiffCT-MLX), adapted from the original [diffct](https://github.com/sypsyp97/diffct) by Yipeng Sun (Apache-2.0).**
> DiffCT-MLX's `main` branch is the Apple Silicon / MLX port; this `cuda` branch is a snapshot of the original CUDA / PyTorch implementation, maintained by [Linda-Sophie Schneider](https://github.com/Linda-SophieSchneider) to evolve in a separate development direction.
