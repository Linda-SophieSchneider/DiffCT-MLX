...
> [!NOTE]
> **本分支是 [DiffCT-MLX](https://github.com/Linda-SophieSchneider/DiffCT-MLX) 的 `cuda` 分支,改编自 [Yipeng Sun](https://github.com/sypsyp97) 的原始项目 [diffct](https://github.com/sypsyp97/diffct)(Apache-2.0)。**
> DiffCT-MLX 的 `main` 分支是 Apple Silicon / MLX 移植版;此 `cuda` 分支是原始 CUDA / PyTorch 实现的快照,由 [Linda-Sophie Schneider](https://github.com/Linda-SophieSchneider) 维护,并朝独立的开发方向演进。
> 完整来源与许可信息见 [ATTRIBUTION.md](ATTRIBUTION.md)。
